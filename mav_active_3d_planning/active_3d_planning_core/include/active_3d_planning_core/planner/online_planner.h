...
#include "active_3d_planning_core/module/trajectory_evaluator/timing.h"  // Include the timing header
...
class OnlinePlanner : public PlannerI, public ModuleBase {
 ...
 protected:
  ...
  // new candidates, ...
  bool p_visualize_only_goal_;
  bool p_eval_visualization_;
  bool p_complte_visualization_;
